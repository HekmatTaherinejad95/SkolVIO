...
######################
#Find the corresponding camera rotation angle and camera translation between the image
######################
...
def init_structure(K, key_points_for_all, colors_for_all, matches_for_all):  
    ...
    #Set the transformation matrix of the first camera, which serves as the basis for the transformation of the remaining camera matrix.
    R0 = np.eye(3, 3)
    T0 = np.zeros((3, 1))
...
#Make image points and space points
